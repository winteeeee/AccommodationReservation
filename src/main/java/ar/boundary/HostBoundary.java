...
public class HostBoundary implements Boundary {
    ...
    private void registBasicAmenities(Accommodation accommodation) {
    ...
    private void registTopAmenities(Accommodation accommodation) {
    ...
    private void registSafetyAmenities(Accommodation accommodation) {
    ...
    private void registAccessibilityAmenities(Accommodation accommodation) {
    ...
    private void registHouse(Host host) {
        ...
        registBasicAmenities(house);
        registTopAmenities(house);
        registSafetyAmenities(house);
        registAccessibilityAmenities(house);
